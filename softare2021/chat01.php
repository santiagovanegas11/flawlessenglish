...
<input disabled type="text" name="reloj" size="25">(tiempo máximo de <?php echo $mt; ?> minutos)..............Tiempo restante<input disabled type="text" name="minuto" size="25"></mark></h4></p>
</td></tr>   
    <tr>
    <td>
    <select name="lamast" id="zona" size = "22"  > <option selected disabled></option>
<option>Bienvenidos al chat de flawless english, aquí puedes aprender y charlar junto a otros usarios y así aclarar tus dudas. Sino es suficiente para ti, puedes ir a nuestro chat en Messenger.</option>
<?php do { 
